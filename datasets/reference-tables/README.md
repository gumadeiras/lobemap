...
- Projection-neuron line status uses Grabe 2015 Table 1 for GH146-GAL4 and
  Grabe 2016 Table S2 for ChAT-GAL4. Sex-specific PN counts come from Grabe
  2016 Table S1; values marked `^b` were measured with ChAT-GAL4.
